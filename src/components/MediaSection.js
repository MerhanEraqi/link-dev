  ...
  return (
    <div className="media-container container">
      ...
      <div className="filter row justify-content-center align-items-center">
        <button type="button" className="col-auto active filter-btn btn btn-sm p-f-4 shadow-none border-0 px-4 py-2 my-2">
          All news
        </button>
        <button type="button" className="col-auto  filter-btn btn btn-sm p-f-4 shadow-none border-0 px-4 py-2 my-2">
          Technology
        </button>
        <button type="button" className="col-auto  filter-btn btn btn-sm p-f-4 shadow-none border-0 px-4 py-2 my-2">
          Sport
